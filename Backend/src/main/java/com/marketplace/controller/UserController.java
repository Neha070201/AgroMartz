...
public class UserController {
	...
	public ResponseEntity<?> RegisterNewUser(@RequestBody User user) {
		...
		String body = "Congratulations Registration is Successfull \n"+ user.getFirstname() + " "+ user.getLastname() +". Welcome to Agromartz Farmers Market Place.";
	...
	public ResponseEntity<?> LoginUser(@RequestBody Authentication userID) {
		...
		String body = "Login Attempt at AgroMartz "+ user.getFirstname() + " "+ user.getLastname() +". \n If not done by you. Contact Bhupali Koparkar from AgroMartz Farmers Market Place.";
